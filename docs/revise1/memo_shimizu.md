...
| Fig5 B 全体 | r=−0.64, n=384 | rs=−0.64, n=381 |
| Fig5 C 閉経前 | r=−0.58, n=38 | rs=−0.61, n=37 |

- Fig5 B・C の n は T-score のある例数にしてあります。いただいた 384 / 38 は DXA ありの例数で、T-score 未記入の 3 例 / 1 例を含みます。
